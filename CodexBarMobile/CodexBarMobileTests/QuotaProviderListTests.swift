...
struct QuotaProviderListTests {
    @Test
    func `Total count is 54 including ClinePass and LongCat`() {
        ...
        // 50 after Qoder, 51 after Sub2API, 52 after ZenMux, and 54 after
        // ClinePass and LongCat.
        ...
        #expect(QuotaProviderList.providers.count == 54)
    }

    @Test
    func `Subscription zone count is 162 (54 providers × 3 states)`() {
        ...
        #expect(QuotaProviderList.providers.count * 3 == 162)
    }
    ...
    @Test
    func `Cause: new providers through ClinePass and LongCat are appended at the tail`() {
        ...
        #expect(tail == [
            ...
            "clinepass", "longcat",
        ], "provider catch-up additions through LongCat must stay at the tail in this order")
    }
    ...
    @Test
    func `Cause: catalog 54/162 numbers match the actual list`() {
        #expect(QuotaProviderList.providers.count == 54)
        #expect(QuotaProviderList.providers.count * 3 == 162)
    }
