            ...
            sections: [
                .init(
                    ...
                    items: [
                        ...
                        String(localized: "Usage organization — provider logos now match the Mac app across cards, detail screens, dashboard provider-share rows, and widgets; you can still choose which provider appears in widgets, and the Usage tab now shows a labeled Provider order button beside the live sync status."),
