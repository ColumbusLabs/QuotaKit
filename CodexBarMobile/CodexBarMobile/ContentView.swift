            ...
            sections: [
                .init(
                    ...
                    items: [
                        ...
                        String(localized: "Widgets and pace — QuotaKit Pro adds refreshed Home Screen and Lock Screen widgets with Session / Weekly configuration, sanitized iPhone-side snapshot data, sync-age badges, quota bars, and pace chips; Usage cards now match the Mac app with deficit/reserve pace labels, projected run-out timing, and expected-usage markers."),
