...
- [ ] **Round 6 / P4b**:UI —— `currentInsights` 按 `cwlEnabled` 分派(`@Environment(modelContext)` + `aggregate`)+ Settings CWL 开关 + Picker(7/30/90/365,`cwlWindowDays`)+ 清空 + 诊断面板 + `Localizable.xcstrings` 4 语 + T8/T9/T12/T13。
