...
- **Round 0(2026-05-28)— Bootstrap docs(本提交)**:创建本目录 5 份文档。
- Round 1+ **未启动**(下一步 = P1 SwiftData schema)。
...
- [ ] **Round 1 / P1**:SwiftData schema —— 新增 `DailyCostPoint` + migration v1→v2。
...
- **Round 0(2026-05-28)— Bootstrap docs**:本目录 5 份文档创建。下一步 Round 1 = P1 SwiftData schema。
