...
| 043 | Four-Provider Teardown Recovery (exact-tree restoration + lifetime entitlement and release safety) | `done` | Build 177 verified in place and internally distributed | [043-four-provider-recovery.md](043-four-provider-recovery.md) | 2026-08-11 |
| 045 | Codex Rolling Weekly Refresh Publication | `done` | Confirmed rolling-window usage publishes without a premature reset event | [045-codex-weekly-refresh-publication.md](045-codex-weekly-refresh-publication.md) | 2026-08-13 |
| 047 | Codex Ledger Memory and Publication Repair | `done` | Implementation and offline gates complete; packaged runtime memory soak remains deferred while QuotaKit stays closed | [047-codex-ledger-memory-publication.md](047-codex-ledger-memory-publication.md) | 2026-09-01 |
| 048 | v0 Platform API provider integration | `done` | iPhone receives existing quota windows; billing detail rows stay on Mac pending old-store migration evidence | [048-v0-platform-api-provider-integration.md](048-v0-platform-api-provider-integration.md) | 2026-09-22 |
