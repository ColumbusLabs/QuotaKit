...
| 043 | Four-Provider Teardown Recovery (exact-tree restoration + lifetime entitlement and release safety) | `in-progress` | Internal build 177 validation | [043-four-provider-recovery.md](043-four-provider-recovery.md) | 2026-08-11 |
