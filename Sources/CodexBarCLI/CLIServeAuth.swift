...
enum CLIServeStartupError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case let .missingDashboardToken(host):
            "--dashboard-token (or QUOTAKIT_DASHBOARD_TOKEN) is required for non-loopback --host '\(host)'."
...
extension CodexBarCLI {
    /// Startup validation for `quotakit serve` binding and dashboard-token flags.
