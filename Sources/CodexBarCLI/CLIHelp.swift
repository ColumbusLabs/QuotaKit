...
extension CodexBarCLI {
    ...
    static func dashboardHelp(version: String) -> String {
        ...
        Usage:
          quotakit dashboard [--pretty] [--timeout <seconds>]
                             [--identity <redacted|full>] [--output <path>]
                             [--json-output] [--log-level <trace|verbose|debug|info|warning|error|critical>]
                             [-v|--verbose]

        Description:
          Print one dashboard-v1 snapshot as JSON, then exit. Honors enabled providers
          in stable order, redacts account identity by default, and keeps provider
          ...
          --identity full includes real account emails in the snapshot; reserve it for
          trusted, private output destinations.
        ...
        Examples:
          ...
          quotakit dashboard --identity full --output /var/www/dashboard/snapshot.json
        """
    }
    ...
    static func configHelp(version: String) -> String {
        ...
        Usage:
          quotakit config validate [--format text|json]
                                 ...
                                 [-v|--verbose]
                                 [--pretty]
          quotakit config dump [--show-secrets] [--format text|json]
                             [--json]
                             [--json-only]
                             [--json-output] [--log-level <trace|verbose|debug|info|warning|error|critical>]
                             [-v|--verbose]
    ...
    static func hooksHelp(version: String) -> String {
        ...
        Usage:
          ...
          quotakit hooks watch [--interval <seconds>] [--provider <name>]
        ...
        Description:
          ...
          Only configure commands you trust.
        ...
        Examples:
          ...
          quotakit hooks watch --interval 600
          quotakit hooks watch --provider codex
        """
    }
