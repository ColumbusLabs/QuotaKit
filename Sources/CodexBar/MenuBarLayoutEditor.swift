...
extension UTType {
    static let codexBarMenuLayoutItem = UTType(exportedAs: "com.columbuslabs.quotakit.menu-layout-item")
}
...
///
/// Palette chips may contain localized or user-defined labels of widely varying width. An adaptive
