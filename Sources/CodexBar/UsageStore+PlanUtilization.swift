...
// Plan-utilization ownership, migration, sampling, and reset detection share one cohesive persistence model.
        ...
        forSessionEquivalents: Bool = false) -> [PlanUtilizationSeriesSample]
    {
        ...
        case .claude:
            ...
            for namedWindow in snapshot.extraRateWindows ?? []
                where namedWindow.usageKnown && namedWindow.window.windowMinutes == Self.weeklyWindowMinutes
            {
