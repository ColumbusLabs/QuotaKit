...
public final class CurrencyExchange: @unchecked Sendable {
    ...
    public static func pickerLabel(for code: String) -> String? {
        guard let currency = self.currencies.first(where: { $0.code == code }) else { return nil }
    ...
    private static let currencies: [(code: String, symbol: String, rate: Double)] = [
        ("USD", "$", 1.0), ("GBP", "£", 0.79), ("EUR", "€", 0.92), ("CZK", "Kč", 21.0),
        ("CNY", "¥", 7.27), ("JPY", "¥", 154.0), ("KRW", "₩", 1428.90), ("CAD", "$", 1.38),
        ("AUD", "$", 1.55), ("HKD", "$", 7.80), ("TWD", "NT$", 32.30), ("SGD", "$", 1.34),
        ("INR", "₹", 84.50), ("CHF", "Fr.", 0.80), ("AED", "د.إ", 3.6725),
        ("TRY", "₺", 48.5),
        // Rates below from open.er-api.com on 2026-09-24.
        ("NZD", "$", 1.761), ("SEK", "kr", 9.908), ("NOK", "kr", 9.480),
        ("DKK", "kr", 6.554), ("PLN", "zł", 3.838), ("BRL", "R$", 5.117),
        ("MXN", "$", 17.47), ("ZAR", "R", 16.36), ("THB", "฿", 33.37),
        ("IDR", "Rp", 17836.0), ("VND", "₫", 25962.0), ("UAH", "₴", 44.86),
    ]
