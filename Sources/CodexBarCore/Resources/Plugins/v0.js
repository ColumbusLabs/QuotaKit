...
defineProvider({
  ...
  async fetchUsage(ctx) {
    ...
    function tokenBilling(value, field) {
      const payload = object(value, field);
    ...
    const billingData = _nullishCoalesce(tokenBillingData, () => quota(billing.data, "billing.data"));
    ...
    if (_optionalChain([tokenBillingData, "optionalAccess", (_6) => _6.onDemandBalance]) !== undefined) {
      rows.push({
