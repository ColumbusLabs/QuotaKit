...
defineProvider({
  ...
  async fetchUsage(ctx) {
    ...
    const primary = _optionalChain([personal, "optionalAccess", (_4) => _4.window]);
    const secondary = _optionalChain([team, "optionalAccess", (_5) => _5.window]);
    const cost = _nullishCoalesce(personal, () => team).cost;
    return {
      empty: primary == null && secondary == null && cost == null,
      primary,
      secondary,
      cost,
