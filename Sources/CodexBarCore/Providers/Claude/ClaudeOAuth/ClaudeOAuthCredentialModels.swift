    ...
    public var errorDescription: String? {
        ...
        case .mcpOAuthOnlyKeychain:
            return "Claude keychain contains MCP OAuth state only (no claudeAiOauth). "
                ...
                + "Open the QuotaKit menu and click Refresh to re-authenticate, "
        ...
        case let .keychainError(status):
            ...
            {
                return "Claude Keychain access was denied. QuotaKit will back off in the background until you retry "
