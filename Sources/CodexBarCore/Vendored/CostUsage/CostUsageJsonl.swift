...
enum CostUsageJsonl {
    ...
    fileprivate struct JSONTailState: Codable, Equatable {
        ...
        /// Persisted checkpoints can contain unusual counters. Keep the scalar updater when
        /// skipping a terminated span could bypass checked depth arithmetic or literal indexing.
