...
public enum OpenCodexUsageParser {
    ...
    private static func nonnegativeInt(_ value: Any?) -> Int? {
        ...
        // Double(Int.max) rounds up to 2^63, where Int.init traps. A strict bound keeps the
        // conversion safe, while the integral check rejects malformed fractional token counts.
