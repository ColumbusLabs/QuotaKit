...
struct GitKrakenPluginTests {
    ...
    """#
    private static let personalAndOrganization = #"""
    {"used":12500,"limit":400000,"resetsOn":"2026-09-27T00:00:00Z",
    ...
    {
        let usage = try await Self.fetch(engine, payload: Self.personalAndOrganization, organization: "org-fixture")
    ...
    private static func fetch(
        ...
        payload: String = Self.personal,
        body: String? = nil,
        statusCode: Int = 200,
        organization: String = "") async throws -> UsageSnapshot
    {
        let transport = ProviderHTTPTransportHandler { request in
            ...
            #expect(request.value(forHTTPHeaderField: "Client-Name") == "QuotaKit")
