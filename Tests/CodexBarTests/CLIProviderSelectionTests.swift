...
struct CLIProviderSelectionTests {
    ...
    func `help includes gemini and all`() {
        ...
        #expect(usage.contains("quotakit usage --provider gemini"))
        #expect(usage.contains("quotakit usage --format json --provider all --pretty"))
        #expect(root.contains("quotakit --provider gemini"))
    }
    ...
    func `help advertises the toon output format`() {
        ...
        #expect(usage.contains("quotakit usage --format toon"))
        #expect(root.contains("quotakit --format toon"))
    }
