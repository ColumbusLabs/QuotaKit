...
struct ProviderArchitectureGatekeeperTests {
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+CodexCostCatchUp.swift",
            line: 359,
            anchor: "guard let current = self.tokenSnapshotPublicationForCurrentProviderConfig(for: .codex)?.snapshot",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 3,
            expectedReferenceFingerprint: ["codex@0", "codex@2", "codex@7"],
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+CodexCostCatchUp.swift",
            line: 401,
            ...
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 6,
            expectedReferenceFingerprint: ["codex@0", "codex@11", "codex@12", "codex@13", "codex@14", "codex@15"],
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+CodexCostCatchUp.swift",
            line: 565,
            anchor: "let publicationRevision = self.tokenSnapshotPublicationRevision(for: .codex)",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 2,
        ...
        AllowedProviderConstruct(
            ...
            expectedReferenceFingerprint: [
                "codex@0", "codex@5", "codex@6", "codex@8", "codex@9",
                "codex@9", "codex@11", "codex@12", "codex@14",
            ],
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+CodexCostCatchUp.swift",
            ...
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 5,
            expectedReferenceFingerprint: ["codex@0", "codex@3", "codex@4", "codex@5", "codex@6"],
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+HighestUsage.swift",
            line: 117,
        ...
        AllowedProviderConstruct(
            ...
            expectedReferenceCount: 6,
            expectedReferenceFingerprint: [
                "claude@0", "claude@11", "antigravity@18", "claude@19", "claude@28", "claude@37",
            ],
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["claude", "codex"],
            expectedReferenceCount: 3,
            expectedReferenceFingerprint: ["claude@0", "codex@6", "codex@14"],
