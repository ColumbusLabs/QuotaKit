...
struct ProviderArchitectureGatekeeperTests {
    ...
    func `descriptor widget colors preserve the pre-derivation literals`() {
        ...
        #expect(widgetFingerprint == 3_588_745_979_333_465_671)
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            ...
            line: 639,
            anchor: "guard provider == .mistral || provider == .xai else { return displayCalendar }",
            expectedProviderIDs: ["mistral", "xai"],
            expectedReferenceCount: 2,
            expectedReferenceFingerprint: ["mistral@0", "xai@0"],
            reason: "Mistral and xAI billing buckets are both defined by UTC service days."),
        AllowedProviderConstruct(
        ...
        AllowedProviderConstruct(
            ...
            expectedReferenceCount: 1,
            expectedReferenceFingerprint: ["claude@0"],
            reason: "Claude history requires its provider-specific composite account discriminator."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+PlanUtilization.swift",
            line: 868,
        ...
        AllowedProviderConstruct(
            ...
            expectedReferenceCount: 2,
            expectedReferenceFingerprint: ["codex@0", "codex@1"],
            reason: "This exact account-selection fallback republishes a preserved Codex snapshot and reset baseline."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenAccounts.swift",
            line: 757,
            anchor: "guard provider == .codex else { return outcome }",
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact Codex publication cluster preserves account ownership across quota, history, and live state."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenAccounts.swift",
            line: 1430,
            ...
            reason: "This exact Codex failure cluster preserves account-scoped guards and fallback state."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenAccounts.swift",
            line: 1469,
            ...
            reason: "This exact account publication preserves DeepSeek profiles and Claude account-scoped pace warnings."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenAccounts.swift",
            line: 1513,
            anchor: "if provider == .claude,",
            ...
            expectedReferenceCount: 1,
            expectedReferenceFingerprint: ["claude@0"],
            reason: "Claude OAuth rate limits preserve the matching account snapshot without crossing identities."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenAccounts.swift",
            line: 1538,
            ...
            expectedReferenceCount: 1,
            expectedReferenceFingerprint: ["deepseek@0"],
            reason: "DeepSeek failures clear its provider-specific profile transition state."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+TokenCost.swift",
            line: 218,
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["claude"],
            expectedReferenceCount: 4,
            expectedReferenceFingerprint: ["claude@0", "claude@7", "claude@8", "claude@10"],
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/UsageStore+WidgetSnapshot.swift",
            line: 309,
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["alibabatokenplan", "amp", "crof", "doubao", "grok"],
            expectedReferenceCount: 5,
            expectedReferenceFingerprint: ["grok@0", "doubao@5", "amp@10", "crof@15", "alibabatokenplan@18"],
        ...
        AllowedProviderConstruct(
            ...
            expectedReferenceCount: 1,
            expectedReferenceFingerprint: ["deepseek@0"],
            reason: "A successful DeepSeek backfill clears its provider-specific profile transition before publishing the recovered snapshot."),
        AllowedProviderConstruct(
        ...
        AllowedProviderConstruct(
            path: "Sources/CodexBar/Sync/SyncCoordinator+ProviderMappers.swift",
            line: 555,
            anchor: "guard provider == .openrouter, let o = snapshot?.openRouterUsage else { return nil }",
            expectedProviderIDs: ["openrouter"],
            expectedReferenceCount: 1,
            expectedReferenceFingerprint: ["openrouter@0"],
            reason: "This exact mapper translates provider-native snapshot fields into the versioned Mac-to-iPhone wire envelope."),
        ...
        AllowedProviderConstruct(
            path: "Sources/CodexBar/Sync/SyncCoordinator.swift",
            line: 766,
            anchor: "if provider == .aiand, let providerCost {",
            expectedProviderIDs: ["aiand", "copilot", "xai"],
            expectedReferenceCount: 3,
            expectedReferenceFingerprint: ["aiand@0", "xai@5", "copilot@9"],
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["aiand", "claude", "neuralwatt", "xai", "zenmux"],
            expectedReferenceCount: 5,
            expectedReferenceFingerprint: ["zenmux@0", "neuralwatt@1", "aiand@2", "xai@3", "claude@7"],
            reason: "Balance-only providers must not be serialized as used-versus-limit budgets with a false zero limit."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/Sync/SyncCoordinator.swift",
            line: 822,
            anchor: "guard provider == .codex else { return extraRateWindows }",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 1,
            expectedReferenceFingerprint: ["codex@0"],
            reason: "Codex optional-credit visibility controls filter only its extra mobile rate windows."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/Sync/SyncCoordinator.swift",
            line: 837,
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["alibabatokenplan", "amp", "cursor", "qwencloud"],
            expectedReferenceCount: 4,
            expectedReferenceFingerprint: ["amp@0", "alibabatokenplan@7", "qwencloud@15", "cursor@21"],
