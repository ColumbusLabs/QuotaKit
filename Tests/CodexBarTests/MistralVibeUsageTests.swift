...
struct MistralVibeUsageTests {
    ...
    @Test
    func `console cookie header rejects malformed ory session cookie values`() {
        let admin = [
            "ory_session_good=val1",
            "ory_session_bad=val\r\nX-Leak: value",
            "ory_session_comma=left,right",
            "ory_session_empty=",
            "unrelated=drop",
        ].joined(separator: "; ")
        ...
        #expect(cookie == "csrftoken=tok; ory_session_good=val1")
    }
