...
struct QuotaProviderListTests {
    @Test
    func `Provider list has expected count (59 after xAI catch-up)`() {
        ...
        // DeepInfra, then 58 after Qwen Cloud and ZoomMate, and 59 after xAI.
    ...
    @Test
    func `iOS subscription count is 59 × 3 = 177 (depleted + restored + warning)`() {
