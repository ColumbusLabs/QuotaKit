...
struct QuotaProviderListTests {
    @Test
    func `Provider list has expected count (52 after ZenMux catch-up)`() {
        ...
        // same upstream line → 51 after Sub2API → 52 after ZenMux. Must stay synced with iOS-side test in
    ...
    @Test
    func `iOS subscription count is 52 × 3 = 156 (depleted + restored + warning)`() {
