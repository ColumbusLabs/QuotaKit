...
struct CloudSyncSettingsTests {
    @Test
    func `Mac fleet sync is separate strict opt in while iPhone sync stays enabled`() throws {
        ...
        #expect(fixture.defaults.object(forKey: "iCloudSyncEnabled") == nil)
        #expect(fixture.defaults.object(forKey: "iCloudSyncIncludeSecrets") == nil)
    }
