...
struct PoeUsageFetcherTests {
    ...
    @Test
    func `history parser accepts millisecond timestamps`() throws {
        let json = """
        {
          "data": [
            {
              "query_id": "ms-1",
              "creation_time": 1717000000000,
              "bot_name": "GPT-4o",
              "usage_type": "API",
              "cost_points": 4
            }
        ...
        #expect(parsed.entries[0].createdAt.timeIntervalSince1970 == 1_717_000_000)
    }
