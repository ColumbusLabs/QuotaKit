...
- Refresh responses must contain a usable access token; malformed responses do not extend the previous token's expiry.
- gcloud retains ownership of its credential file; QuotaKit uses refreshed tokens in memory.
