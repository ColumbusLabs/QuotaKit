...
when one is reported. Large finite token counts remain displayable without integer overflow. Nonfinite quota or
fuel-pack totals are omitted independently, malformed or unrepresentable response codes fail parsing, and dates with
an unrepresentable countdown retain their balance detail without a reset countdown.
