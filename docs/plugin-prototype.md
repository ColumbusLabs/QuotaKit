...
Set the compatibility variable `CODEXBAR_JS_PROVIDERS=1` in QuotaKit's environment. Synthetic, OpenAI, z.ai, Poe,
xAI, Manus, Perplexity, T3 Chat, Qoder, OpenRouter, ClawRouter, Deepgram, and sub2api then prepend a script strategy
