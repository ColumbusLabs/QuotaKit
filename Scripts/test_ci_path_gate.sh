...
assert_ios_gate true ios-testflight-clang-wrapper $'M\tScripts/xcode-clang-probe-wrapper.sh'
assert_ios_gate true ios-testflight-wrapper $'M\tScripts/upload_ios_testflight.sh'
assert_ios_gate true ios-testflight-test $'M\tScripts/test_ios_testflight_release_lane.sh'
